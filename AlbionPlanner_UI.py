...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkAbbr.setGeometry(QtCore.QRect(220, 80, 150, 24))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.checkAbbr.setFont(font)
        self.checkAbbr.setText("地图缩写")
        self.checkAbbr.setChecked(False)
        self.checkAbbr.setTristate(False)
        # 地图全名 checkFull
        self.checkFull = QtWidgets.QCheckBox(self.centralwidget)
        self.checkFull.setGeometry(QtCore.QRect(220, 100, 100, 24))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.checkFull.setFont(font)
        self.checkFull.setText("地图全名")
        self.checkFull.setChecked(True)
        self.checkFull.setTristate(False)
        # 二选一
        def checkAbbrChange():
            if self.checkAbbr.isChecked() == True:
                self.checkFull.setChecked(False)
            if self.checkAbbr.isChecked() == False:
                self.checkFull.setChecked(True)
        def checkFullChange():
            if self.checkFull.isChecked() == True:
                self.checkAbbr.setChecked(False)
            if self.checkFull.isChecked() == False:
                self.checkAbbr.setChecked(True)
        self.checkAbbr.stateChanged.connect(checkAbbrChange)
        self.checkFull.stateChanged.connect(checkFullChange)

        # 计时警报 check
        self.checkAlert = QtWidgets.QCheckBox(self.centralwidget)
        self.checkAlert.setGeometry(QtCore.QRect(50, 520, 500, 60))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.checkAlert.setFont(font)
        self.checkAlert.setText("计时提醒（5/2/1分钟警报）并自动复制到剪贴板")
        self.checkAlert.setWhatsThis("五分钟响一下，两分钟响两下，一分钟响三下")
        self.checkAlert.setChecked(True)
        ...
        self.table.setColumnWidth(0,10)     # 图标
        self.table.setColumnWidth(1,95)     # 剩余时间
        self.table.setColumnWidth(2,80)     # 资源
        self.table.setColumnWidth(3,150)    # 地图
        self.table.setColumnWidth(4,58)     # 备注
        self.table.setColumnWidth(5,80)     # UTC
        ...
        self.frameline_3.setGeometry(QtCore.QRect(325, 20, 20, 500))
